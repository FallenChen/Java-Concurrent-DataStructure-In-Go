...
func (this *Wireup) Build() (Writer, Reader) {
	var writeSequence = NewCursor()
	readers, readBarrier := this.buildReaders(writeSequence)
	return NewWriter(writeSequence, readBarrier, this.capacity), compositeReader(readers)
}
